 ...
 */
#include "bayestracking/BayesFilter/infRtFlt.hpp"
#include "bayestracking/BayesFilter/matSup.hpp"
#include "bayestracking/BayesFilter/uLAPACK.hpp"	// Common LAPACK interface
#include <algorithm>
